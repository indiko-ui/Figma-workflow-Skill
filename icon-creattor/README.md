...
**Version:** 3.7 · **Author:** indiko-ui · **Runtime:** Figma Agent (`use_figma`) + figma-console-mcp Desktop Bridge

---

## ติดตั้ง

**Figma Make / Figma Agent** — รับเฉพาะไฟล์ `.md`:
1. Prompt box → **Skills** → **Create skill**
2. Drag `icon-creator.md` เข้าไป หรือ Import from computer
3. Review → Create
4. เรียกด้วย `/icon-creator` หรือพิมพ์ trigger (ดูด้านล่าง)

> ⚠️ `.skill` (ZIP) ใช้กับ Claude Code/Cursor เท่านั้น — Figma Make ใช้ `.md` plain file
